...
if ($result->num_rows > 0): ?>
    <table>
        ...
        <tr>
            ...
            <td><a href="student-edit1.php?id=<?php echo $row1->employeeID; ?>">Edit</a></td>
            <td><a href="student-delete.php?id=<?php echo $row1->employeeID; ?>" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a></td>
        </tr>
        <?php } ?>
    </table>
<?php else: ?>
